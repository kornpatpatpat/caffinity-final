...
export default function Onboarding({ onComplete }: OnboardingProps) {
  ...
  return (
    <motion.div 
      ...
      exit={{ opacity: 0, y: -20 }}
      className="min-h-screen flex flex-col p-8 max-w-md mx-auto bg-background"
    >
        ...
        <div className="bg-card rounded-[40px] p-10 shadow-sm space-y-8">
          <div className="space-y-2">
            ...
            <Input 
              ...
              className="border-0 border-b border-gray-200 rounded-none px-0 text-3xl focus-visible:ring-0 focus-visible:border-black transition-colors"
            />
          </div>
